...
@section('content')
  ...
  <div class="bg-gray-100 font-sans text-gray-800">
    <div class="min-h-full flex items-center justify-center p-3 sm:p-4">
      ...
      <!-- باکس اصلی سفید -->
      <div
        class="w-full md:w-[600px] lg:w-[1100px] bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col lg:flex-row">
            ...
            <form action="" class="space-y-6">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-12 gap-3">
                ...
                <div class="relative w-full">
                  <input type="text" name="customer" placeholder="نام راننده"
                    class="w-full border rounded-xl py-3 p-x-14 pr-2 text-right">

                  <!-- آیکن سمت چپ -->
                  <svg class="w-4 h-4  absolute left-2 top-1/2 -translate-y-1/2 text-gray-500" viewBox="0 0 24 24"
                    ...
                    <path d="M18.7002 16.25C19.0002 17.33 19.8402 18.17 20.9202 18.47" stroke="#292D32" stroke-width="1.5"
                ...
                {{-- عکس --}}
                <div class="relative w-full">
                  <input type="text" name="customer" placeholder="عکس "
                    class="w-full border rounded-xl py-3 p-x-14 pr-2 text-right ">
                ...
                {{-- شماره تماس--}}
                <div class="relative w-full">
                  <input type="text" name="customer" placeholder=" شماره تماس"
                    class="w-full border rounded-xl py-3 p-x-14 pr-2 text-right">
                ...
                {{-- مدرک --}}
                <div class="relative w-full">
                  <input type="text" name="customer" placeholder=" مدرک"
                    class="w-full border rounded-xl py-3 p-x-14 pr-2 text-right">

                  <!-- آیکن سمت چپ -->
                  <svg class="w-4 h-4  absolute left-2 top-1/2 -translate-y-1/2 text-gray-500" viewBox="0 0 24 24"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.3701 8.87988H17.6201" stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round" />
                    <path d="M6.37988 8.87988L7.12988 9.62988L9.37988 7.37988" stroke="#292D32" stroke-width="1.5"
                      stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M12.3701 15.8799H17.6201" stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round" />
                    <path d="M6.37988 15.8799L7.12988 16.6299L9.37988 14.3799" stroke="#292D32" stroke-width="1.5"
                      stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z"
                      stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                ...
                {{-- آدرس خانه --}}
                <div class="relative w-full">
                  <input type="text" name="customer" placeholder=" آدرس خانه"
                    class="w-full border rounded-xl py-3 p-x-14 pr-2 text-right ">

                  <!-- آیکن سمت چپ -->
                  <svg class="w-4 h-4  absolute left-2 top-1/2 -translate-y-1/2 text-gray-500" viewBox="0 0 24 24"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 22H22" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                      stroke-linejoin="round" />
                    <path
                    ...
                    <path d="M15.5 11H8.5C7.67 11 7 11.67 7 12.5V22H17V12.5C17 11.67 16.33 11 15.5 11Z" stroke="#292D32"
                      stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M10 16.25V17.75" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10"
                      stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M10.5 7.5H13.5" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10"
                      stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                ...
                {{-- درآمد --}}
                <div class="relative w-full">
                  <input type="text" name="customer" placeholder=" درآمد "
                    class="w-full border rounded-xl py-3 p-x-14 pr-2 text-right ">
                ...
                {{-- تعداد سفرها --}}
                <div class="relative w-full">
                  <input type="text" name="customer" placeholder=" تعداد سفر ها"
                    class="w-full border rounded-xl py-3 p-x-14 pr-2 text-right ">

                  <!-- آیکن سمت چپ -->
                  <svg class="w-4 h-4  absolute left-2 top-1/2 -translate-y-1/2 text-gray-500" viewBox="0 0 24 24"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 2V12C15 13.1 14.1 14 13 14H2V6C2 3.79 3.79 2 6 2H15Z" stroke="#292D32" stroke-width="1.5"
                      stroke-linecap="round" stroke-linejoin="round" />
                    <path
              ...
              <div class="flex flex-col sm:flex-row sm:mt-6 justify-between mt-6 gap-4">
                ...
                <a href="{{ url('/drivers-Information') }}"
        ...
        <div class="flex-1 lg:w-5/12 flex items-center justify-center p-4 sm:p-5 order-1 lg:order-2">
          <div class="w-full max-w-[420px]">
            <img src="/img/img_2025.jpg" alt="Success Illustration" class="w-full  h-[550px] object-cover rounded-2xl">
          </div>
        </div>
