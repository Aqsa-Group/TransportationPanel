      ...
      <div class="w-full max-w-md">
        ...
        <div class="border-t-2 mt-2 border-[#0400FF] mb-4"></div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-9">
            ...
            <!-- عکس-->
            <div class="relative">
                <input type="text" name="driver" placeholder="عکس"
                class="w-full border border-gray-400 rounded-xl px-3 pl-10 py-2 text-right outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-500 bg-white"/>
                <span class="absolute left-3 top-1/2 -translate-y-1/2">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- تماس -->
            <div class="relative">
                <input type="text" name="origin" placeholder="تماس"
                class="w-full border border-gray-400 rounded-xl px-3 pl-10 py-2 text-right outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-500 bg-white"/>
                <span class="absolute left-3 top-1/2 -translate-y-1/2">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- مدرک -->
            <div class="relative">
                <input type="text" name="destination" placeholder="مدرک"
                class="w-full border border-gray-400 rounded-xl px-3 pl-10 py-2 text-right outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-500 bg-white"/>
                <span class="absolute left-3 top-1/2 -translate-y-1/2">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- آدرس خانه -->
            <div class="relative">
                <input type="text" name="start_date" placeholder="آدرس خانه"
                class="w-full border border-gray-400 rounded-xl px-3 pl-10 py-2 text-right outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-500 bg-white"/>
                <span class="absolute left-3 top-1/2 -translate-y-1/2">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- درآمد -->
            <div class="relative">
                <input type="text" name="end_date" placeholder="درآمد"
                class="w-full border border-gray-400 rounded-xl px-3 pl-10 py-2 text-right outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-500 bg-white"/>
                <span class="absolute left-3 top-1/2 -translate-y-1/2">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- تعداد سفرها -->
            <div class="relative">
              <input type="text" name="estimated_time" placeholder="تعداد سفرها"
                class="w-full border border-gray-400 rounded-xl px-3 pl-10 py-2 text-right outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-500 bg-white"/>
                <span class="absolute left-3 top-1/2 -translate-y-1/2">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="flex flex-col sm:flex-row justify-between mt-6 gap-4">
            <a href="{{ route('drivers.page') }}" class="w-full sm:w-[48%] py-3 rounded-xl bg-[#FF0000] hover:bg-[#CA0808] text-white text-base font-semibold text-center">
              برگشت
            </a>

            <a href="{{ route('drivers.info') }}" class="w-full sm:w-[48%] py-3 rounded-xl hover:bg-blue-800 bg-[#0400FF] text-white text-base font-semibold text-center">
              ثبت
            </a>
          </div>
        </form>
