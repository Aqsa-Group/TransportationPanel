...
<div class="p-4 bg-white rounded-2xl shadow mx-auto mt-4 max-w-full md:w-[95%] lg:w-[1200px]">
    ...
    <div class="flex flex-col sm:flex-row justify-between sm:items-center mb-4 gap-3">
        ...
        <div class="flex justify-center sm:justify-end w-full sm:w-auto">
            <button onclick="window.location.href='{{ url('/customers-Form') }}'" 
                class="bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg px-4 py-2 flex items-center justify-center gap-2 text-sm sm:text-base">
    ...
    <!-- جدول دسکتاپ -->
    <div class="overflow-x-auto rounded-lg mt-4 hidden md:block">
        <table class="min-w-full bg-white text-right text-sm border-t border-b border-gray-200">
            <thead class="bg-gray-100 text-gray-600">
                <tr class="text-center border-b border-dashed border-gray-300">
                    <th class="p-3">عکس</th>
    ...
    <div class="space-y-4 md:hidden mt-4">
        ...
        <div class="bg-white p-4 rounded-2xl shadow border border-gray-200">
            <div class="flex items-center gap-3 mb-3">
                <img src="{{ $customer->photo }}" class="w-12 h-12 rounded-2xl border">
                <div class="flex-1 text-right">
                    <p class="font-bold text-gray-800 text-base">{{ $customer->customer_name }}</p>
                    <p class="text-xs text-gray-500">{{ $customer->gmail }}</p>
                </div>
            </div>
