      ...
      <div class="w-full max-w-md">
        ...
        <form action="#" class="space-y-6 w-full">
          ...
          <div class="flex flex-col sm:flex-row justify-between mt-6 gap-4">
            <a href="{{ route('orders.page') }}" class="w-full sm:w-[48%] py-3 rounded-xl bg-[#FF0000] hover:bg-[#CA0808] text-white text-base font-semibold text-center">
              برگشت
            </a>
            <a href="{{ route('orders.info') }}" class="w-full sm:w-[48%] py-3 rounded-xl hover:bg-blue-800 bg-[#0400FF] text-white text-base font-semibold text-center">
              ثبت
            </a>
          </div>
        </form>
